...
4). `getExtractedMovie()`: Just a security method, which lets you get the movie object again without scraping the web again. <br>
**Calling this method before the web scrape will return an object with all null fields with an exception of URL field.** <br>
